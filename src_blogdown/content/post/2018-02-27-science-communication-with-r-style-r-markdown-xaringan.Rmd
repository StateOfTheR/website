...
[Original Xaringan slides by Antoine are available here](https://abichat.github.io/Slides/ScienceCommunicationSOTR/ScienceCommunicationSOTR.html)
...
[`r icon::fa("stack-overflow", size = 1)` Relationship between R Markdown, Knitr, Pandoc, and Bookdown](https://stackoverflow.com/questions/40563479)
...
![Alt](../2018-02-27-science-communication-with-r-style-r-markdown-xaringan_data/CreateRmd1.png#left){width=45%}
![Alt](../2018-02-27-science-communication-with-r-style-r-markdown-xaringan_data/CreateRmd2.png#right){width=45%}

## New `.Rmd`

![Alt](../2018-02-27-science-communication-with-r-style-r-markdown-xaringan_data/CreateRmd3.png#center)

## Compile `.Rmd`

Use the `Knit` button to produce a HTML file

![Alt](../2018-02-27-science-communication-with-r-style-r-markdown-xaringan_data/CreateRmd4.png#center){width=40%}
...
[`r icon::fa("link", size = 1)` Pets or livestock? Naming your RMarkdown chunks](http://www.masalmon.eu/2017/08/08/chunkpets/)
...
![Alt](../2018-02-27-science-communication-with-r-style-r-markdown-xaringan_data/CreateRmd5.png#center){width=50%}
