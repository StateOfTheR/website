...
[Original Xaringan slides by Antoine are available here](https://abichat.github.io/Slides/IntroTidyverseSOTR/IntroTidyverseSOTR.html#1)
...
Row names are variables so they must have their own column. `rownames_to_column()` can help you.
...
## Syracuse conjecture: application example
...
`r icon::fa("linkedin-in", size = 1)` <a href="https://www.linkedin.com/in/antoinebichat" target="_blank">antoinebichat</a>
